            ...
            <div className="">
              ...
              <div className="mt-2">
                ...
                <div className="flex ">
                  <h1 className="text-lg titillium ">&nbsp;•&nbsp;</h1>
                  <h1 className="text-lg titillium ">
                    Documented support activities and solutions in knowledge
                    base articles, enabling efficient problem-solving and
                ...
                <div className="flex ">
                  ...
                  <h1 className="text-lg titillium ">
                    ...
                    of software applications and operating systems for
                    end-users, ensuring seamless functionality across the
                    organization.
                  </h1>
                </div>
              </div>
            ...
            <div className="">
              ...
              <div className="mt-2">
                ...
                <div className="flex ">
                  <h1 className="text-lg titillium ">&nbsp;•&nbsp;</h1>
                  <h1 className="text-lg titillium ">
                    Proficiency in diagnosing and troubleshooting a wide range
                    of hardware issues and system failures.
                  </h1>
                </div>
              </div>
            </div>
              ...
              <div className="mt-2">
                ...
                <div className="flex ">
                  ...
                  <h1 className="text-lg titillium ">
                    ...
                    enhancements to develop and test new features based on
                    client requirements.
                  </h1>
                </div>
                <div className="flex ">
                  ...
                  <h1 className="text-lg titillium ">
                    ...
                    testers to work closely with cross-functional teams to
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="lg:flex justify-center mt-10 lg:visible hidden">
          <div className="lg:flex ">
              ...
              <SlideReveal>
                <ul className="">
                  <li
                    ...
                    } rounded-3xl m-5 hover:ring-4 transition ease-in-out duration-100 cursor-pointer ${
                      chosenButton == 12
            ...
            <div
              className={`rounded-3xl px-10 py-5 m-5 max-w-2xl ${
                darkMode ? "bg-gray-700 text-white" : "bg-white"
              }`}
              id="card"
            >
            ...
            >
              <div className="">
                ...
                <div className="mt-2">
                  ...
                  <div className="lg:py-0 py-3"></div>
                </div>
              </div>
            </div>
          </Reveal>
              ...
              <div className="">
                ...
                <div className="mt-2">
                  <div className="flex ">
                    <h1 className="text-lg titillium ">&nbsp;•&nbsp;</h1>
                    <h1 className="text-lg titillium ">
                      Provided essential IT support to employees,
                      troubleshooting various hardware and software issues
                      promptly
                    </h1>
                  </div>
                  <div className="flex ">
                  ...
                  <div className="flex ">
                    <h1 className="text-lg titillium ">&nbsp;•&nbsp;</h1>
                    <h1 className="text-lg titillium ">
                      Assisted in the installation, configuration, and
                      maintenance of software applications and operating systems
                      for end-users, ensuring seamless functionality across the
                      organization.
                    </h1>
                  </div>
                  <div className="lg:py-0 py-3"></div>
